...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".toggler {\n   background: rgb(30,30,30);\n   color: white;\n   padding: 10px;\n   font-weight: 700;\n   border-radius: 10px;\n   text-align: center;\n}", "",{"version":3,"sources":["webpack://src/components/toggle/toggle.css"],"names":[],"mappings":"AAAA;GACG,yBAAyB;GACzB,YAAY;GACZ,aAAa;GACb,gBAAgB;GAChB,mBAAmB;GACnB,kBAAkB;AACrB","sourcesContent":[".toggler {\n   background: rgb(30,30,30);\n   color: white;\n   padding: 10px;\n   font-weight: 700;\n   border-radius: 10px;\n   text-align: center;\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=app.e2f4a6f3ab3166167875.hot-update.js.map