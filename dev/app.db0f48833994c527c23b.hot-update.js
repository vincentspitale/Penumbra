...
class Toggle extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  ...
  cssCode() {
    return this.state.isDark ? "video, embed {  -webkit-filter: invert(100%) grayscale(100%); } " : "video, embed {  -webkit-filter: none; } ";
  }
  ...
  updateTabs() {
    chrome.tabs.query({}, function (tabs) {
      for (var i = 0; i < tabs.length; ++i) {
        var tab = tabs[i];
        if (tab.url && tab.url.slice(0, 4) == "http") this.insertCode(tab.id);
      }
    });
  }
...
//# sourceMappingURL=app.db0f48833994c527c23b.hot-update.js.map