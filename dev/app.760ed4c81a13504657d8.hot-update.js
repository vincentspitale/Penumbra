...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".toggler {\n   background: rgb(53, 53, 53);\n   color: white;\n   padding: 10px;\n   font-weight: 700;\n   border-radius: 10px;\n   text-align: center;\n}\n\n.toggled {\n    background: rgb(28, 72, 99);\n}\n\n.button {\n    background: none;\n    border: 0;\n}", "",{"version":3,"sources":["webpack://src/components/toggle/toggle.css"],"names":[],"mappings":"AAAA;GACG,2BAA2B;GAC3B,YAAY;GACZ,aAAa;GACb,gBAAgB;GAChB,mBAAmB;GACnB,kBAAkB;AACrB;;AAEA;IACI,2BAA2B;AAC/B;;AAEA;IACI,gBAAgB;IAChB,SAAS;AACb","sourcesContent":[".toggler {\n   background: rgb(53, 53, 53);\n   color: white;\n   padding: 10px;\n   font-weight: 700;\n   border-radius: 10px;\n   text-align: center;\n}\n\n.toggled {\n    background: rgb(28, 72, 99);\n}\n\n.button {\n    background: none;\n    border: 0;\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=app.760ed4c81a13504657d8.hot-update.js.map