...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".toggler {\n   background: rgb(30,30,30);\n   color: white;\n   padding: 10px;\n   font-weight: 700;\n   border-radius: 10px;\n}", "",{"version":3,"sources":["webpack://src/components/toggle/toggle.css"],"names":[],"mappings":"AAAA;GACG,yBAAyB;GACzB,YAAY;GACZ,aAAa;GACb,gBAAgB;GAChB,mBAAmB;AACtB","sourcesContent":[".toggler {\n   background: rgb(30,30,30);\n   color: white;\n   padding: 10px;\n   font-weight: 700;\n   border-radius: 10px;\n}"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=app.49dc2233714a5d8e59dd.hot-update.js.map