...
class Toggle extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(props) {
    super(props);
    this.state = {
      isDark: false //window.localStorage.getItem('isDark'),

    };
  }

  toggle() {//window.localStorage.setItem('isDark', !this.state.isDark)
...
//# sourceMappingURL=app.f6f6df1ccf5ffffa4f0a.hot-update.js.map