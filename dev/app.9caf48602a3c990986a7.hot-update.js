...
chrome.contextMenus.onClicked.addListener(updateTabs(localStorage.isDark));
chrome.tabs.onUpdated.addListener(function (tabId, info) {
  //  if (info.status && info.status == "complete")
  insertCode(tabId, localStorage.isDark); //  else if (info.url && info.url.slice(0,4) == "http") 
  //      insertCSS(tabId);
});
...
//# sourceMappingURL=app.9caf48602a3c990986a7.hot-update.js.map